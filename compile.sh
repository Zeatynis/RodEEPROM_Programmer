...
avr-gcc -mmcu=atmega1284p -DF_CPU=20000000 -Os Micocontroller/Microcontroller_Main.c Micocontroller/_RodEEPROM_SerialComms.c Micocontroller/_RodEEPROM_Programmer.c Micocontroller/_SteveUART_debug.c -o ../Build/Rod_EEPROM_Programmer.elf
