...
/*
 * _RodEEPROM_Terminal.h - header for functions for Command Line Interface
...
#ifdef  DEBUG
	#define putchar(c); putchar(c); printf("Micro Sent     -> |%i|\n",c);
...
extern uint8_t _RodEEPROM_EstablishSerialConnection(); /* Establishes Serial Connection with PC, returns 1 if successful*/
